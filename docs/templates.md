---
title: "Catalyst Center Template Types"
engine: shared
kind: docs
topic: templates
...
* [Velocity Scripting](./velocity/basics.md)
* [Jinja2 Scripting](./jinja2/basics.md)
...
* [If Statements](./velocity/basics.md#if-statements)
* [Macros](./velocity/basics.md#macros)
* [Loops](./velocity/basics.md#foreach-loops)
* [Multiline commands](./velocity/basics.md#multi-line-commands)

#### Jinja2 Scripting Logic

* [If Statements](./jinja2/basics.md#conditional-statements)
* [Macros](./jinja2/basics.md#macros)
* [Loops](./jinja2/basics.md#for-loops)
* [Multiline commands](./jinja2/basics.md#multi-line-commands)
...
1. From the Catalyst Center home page, choose Tools > Template Editor. By default, the Onboarding Configuration project is available for creating PnP templates. You can create your own custom projects. Templates created in custom projects are categorized as day-N templates.
   ...
   ![json](../images/templates/GoToTemplateEditor.png)
...
2. In the tree pane, select the project under which you are creating templates, and click the gear icon > Add Templates. Alternately, click > Add Templates.
   ...
   ![json](../images/templates/CreateTemplate.png)

3. In the Add New Template window, click Regular Template.

   ![json](../images/templates/AddNewTemplate.png)
...
5. In the Project Name drop-down list, select the project. 
   ...
   ![json](../images/templates/SelectTemplateProject.png)
...
8. Click Edit to view the selected device types and choose the device types that you want to apply to the template.
   ...
   ![json](../images/templates/SelectDeviceTemplate.png)
...
10. From the Software Type drop-down list, choose the software type: IOS, IOS-XE, IOS-XR, NX-OS, Cisco Controller, Wide Area Application Services, Adaptive Security Appliance, NFV- OS, and Others.
   ...
   ![json](../images/templates/SelectOSTemplate.png)
...
12. Click Add. The template is created and shown in the tree view under the project you selected.
   ...
   ![json](../images/templates/AddTemplate.png)
...
14. In the Template Editor window, enter content for the template. You can use the Velocity Template Language (VTL) to write the content in the template.
   ...
   ![json](../images/templates/EditTemplateWindow.png)
